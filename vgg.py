...
class VGG16(Replayer):
    """Class for VGG16 models."""
    ...
    def __init__(self, 
        ...
        #self.lamda_rcl = 1.
        #self.lamda_vl = 1.
        self.lamda_pl = 1.  #--> when used as "classifier with feedback-connections", this should be set to 1.
        ...
        # -fully connected hidden layers || features
        ...
        #>----Classifier----<##
        self.classifier = fc_layer(vgg_output_size, classes, excit_buffer=True, nl='none')
        ...
        layers = get_customized_vgg16_layers(
    ...
    def name(self):
        ...
        return "{}(-c{})".format(self.label, self.classes)
    ...
    def list_init_layers(self):
        ...
        list += self.net.list_init_layers()
        return list
...
#     #    return reconL
    ...
    def loss_function(self, x, y_hat=None, y_target=None, scores=None):
    ...
    def train_a_batch(self, x, y, x_=None, y_=None, scores_=None, rnt=0.5, active_classes=None, task=1, **kwargs):
        ...
        if x is not None:
            ...
            predL = self.loss_function(x=x, y_hat=y_hat, y_target=y)
            # # Weigh losses as requested
            # loss_cur = self.lamda_rcl*reconL + self.lamda_vl*variatL + self.lamda_pl*predL
            loss_cur = self.lamda_pl*self.loss_function(x=x, y_hat=y_hat, y_target=y)
